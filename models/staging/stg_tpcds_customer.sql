with
    source as (select * from {{ source("tpcds", "customer") }}),
    renamed as (
        select
            c_customer_sk as customer_key,
            c_customer_id as customer_id,
            c_current_cdemo_sk as current_customer_demographics_key,
            c_current_hdemo_sk as current_household_demographics_key,
            c_current_addr_sk as current_address_key,
            c_first_shipto_date_sk as first_shipto_date_key,
